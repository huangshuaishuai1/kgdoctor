...
public class LoginController {
    ...
    @PostMapping
    public Result<UserResponse> login(@RequestBody LoginUser userLogin){

        //进行登录，并将这个token返回给前台
        UserResponse userResponse = userService.login(userLogin.getEmail(),userLogin.getPassword());
        log.debug(userResponse.getToken());
